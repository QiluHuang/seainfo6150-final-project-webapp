...
const allDishes = {
    "1": {"0101-chicken-with-sweet-cream-corn-soup": {
...
describe("DishDetail tests", () => {
    it("renders the DishDetail component correctly", () => {
    const { container } = render(<Router><DishDetail dish={allDishes} /></Router>);
